...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _treeModel = __webpack_require__(163);
	...
	var App = function (_React$Component) {
		...
		_createClass(App, [{
			...
			value: function render() {
				return _react2.default.createElement(_treeModel2.default, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../node_modules/css-loader/index.js!./treeModel.css", function() {
				var newContent = require("!!../node_modules/css-loader/index.js!./treeModel.css");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body {\r\n  font-family: \"Arial\";\r\n  background: #343d46;\r\n}\r\n\r\n.treeModel-node-container {\r\n\twidth: 100%;\r\n\tbackground-color: rgb(137, 139, 143);\r\n\tcolor: rgb(55, 55, 55);\r\n\theight: 40px;\r\n\tpadding-left: 10px;\r\n\tpadding-top: 20px;\r\n\tborder-bottom: solid 1px rgb(73, 73, 73);\r\n}\r\n\r\n.treeModel-node-container:hover {\r\n\tcolor: rgb(225, 225, 225);\r\n\tborder-color: rgb(73, 73, 73);\r\n}\r\n\r\n.treeModel-leaf-container {\r\n\twidth: 100%;\r\n\tbackground-color: rgb(94, 96, 99);\r\n\tcolor: rgb(255, 255, 255);\r\n\theight: 30px;\r\n\tpadding-left: 20px;\r\n\tpadding-top: 15px;\r\n\tborder-bottom: solid 1px rgb(73, 73 ,73);\r\n\tlist-style-type: none;\r\n}\r\n\r\n.treeModel-leaf-container:hover {\r\n\tbackground-color: #343d46;\r\n\r\n}\r\n\r\n.treeModel-load-more-container {\r\n\twidth: 100%;\r\n\tbackground-color: rgb(255, 255, 255);\r\n\tcolor: rgb(94, 96, 99);\r\n\theight: 30px;\r\n\tpadding-left: 20px;\r\n\tpadding-top: 15px;\r\n\ttext-align: center;\r\n\tlist-style-type: none;\r\n}\r\n\r\n.treeModel-load-more-container:hover {\r\n\tbackground-color: rgb(200, 200, 200);\r\n}\r\n\r\n\r\n.react-treeModel-default-search-input {\r\n  width: 300px;\r\n  vertical-align: middle;\r\n  margin-bottom: 20px;\r\n  white-space: nowrap;\r\n  position: relative;\r\n  height: 50px;\r\n  border: none;\r\n  font-size: 15pt;\r\n  color: #63717f;\r\n  padding-left: 25px;\r\n\r\n}\r\n\r\n\r\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _searchInput = __webpack_require__(164);

	var _searchInput2 = _interopRequireDefault(_searchInput);

	var _nestedObjects = __webpack_require__(165);
	 ...
	 *  @class TreeModel
	 */
	var TreeModel = function (_React$Component) {
		_inherits(TreeModel, _React$Component);

		/*
	  *  @constructs TreeModel
	  */
		function TreeModel(props) {
			_classCallCheck(this, TreeModel);

			var _this = _possibleConstructorReturn(this, (TreeModel.__proto__ || Object.getPrototypeOf(TreeModel)).call(this, props));
	  ...
	  */
	   ...
	   */
			...
			value: function findFiltered(trees, node, key) {
				...
				if (!node.nodes) {
					...
					var filteredSubFolder = node.nodes.length ? node.nodes.reduce(function (p, c, k) {
	   ...
	   *	@param {string} keyPath - the path to current node/leaf, e.g.  "0.nodes.1"
	   */
			...
			value: function setDisplayTree(tree, prevs, curr, keyPath) {
				...
				if (!curr.nodes) {
					...
					var parentPath = Object.assign([], keyPathArray).splice(0, keyPathArray.length - 2);
					var parentNode = (0, _get3.default)(this.props.tree, parentPath);
					var filteredChildren = parentNode.nodes.some(function (child) {
						return child.isSearchDisplay === true;
					}) ? parentNode.nodes.filter(function (child) {
						return child.isSearchDisplay === true;
					}) : parentNode.nodes;
					var itemKey = "treeModel-leaf-" + curr.id;
					...
					if (shouldDisplay && parentMaxLeaves > relativeIndex) {
						if (curr.customComponent) {
							...
							prevs.push(_react2.default.createElement(
								"li",
								{ key: itemKey,
									className: "treeModel-leaf-container",
									onMouseDown: function onMouseDown(e) {
						...
						if (relativeIndex === filteredChildren.length - 1) {
							if (currCustomloadMoreComponent) {
								...
								prevs.push(_react2.default.createElement(
									"li",
									{ key: itemKey,
										className: "treeModel-load-more-container",
										onClick: this.onLoadMoreClick.bind(this, tree, curr, keyPath)
									},
									_react2.default.createElement(
										"span",
				...
				/*the node*/
						...
						var key = "treeModel-node-" + currLevel + "-" + curr.id;
						...
						if (!curr.isOpen && !isSearching || !curr.isSearchOpen && isSearching) {
							if (shouldDisplay) {
								if (curr.customComponent) {
									...
									prevs.push(_react2.default.createElement(
										...
										{ key: key,
											onClick: this.onNodeClick.bind(this, tree, curr, keyPath),
											className: "treeModel-node-container"
										},
										_react2.default.createElement(
											"label",
											null,
							...
							if (shouldDisplay) {
								...
								var nodesList = curr.nodes.length ? curr.nodes.reduce(function (p, c, k) {
									if (c === undefined || k === undefined) {
										return p;
									}
									return _this3.setDisplayTree(tree, p, c, keyPath + ".nodes." + k);
								}, []) : [];

								if (nodesList.length > 0) {
									openedNode.push(_react2.default.createElement(
										"ul",
										{ key: "treeModel-nodes-list" + currLevel },
										nodesList
									));
								}
	   ...
	   */
			...
			value: function render() {
				...
				return _react2.default.createElement(
					"div",
					{ className: "treeModel-container" },
					headerContent,
					_react2.default.createElement(
						"div",
						{ className: "treeModel-display-tree-container" },
						bodyContent
					)
				);
			}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Hash = __webpack_require__(184),
	    ListCache = __webpack_require__(199),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var assocIndexOf = __webpack_require__(202);
